...
describe('Create meter', () => {
    it('should be create a meter', async () => {
        const result = await index.meterCreate({body: JSON.stringify(request.create.body)});
...
describe('Update meters', () => {
    it('Update Success', async () => {
        ...
        result = await index.meterUpdate({body: JSON.stringify(meterToUpdate)})
...
describe('Get clients', () => {
    it('Get all', async () => {
        const result = await index.clientGetAll();
        const body = JSON.parse(result.body)
        expect(body.totalDocs).toEqual(expect.any(Number));
    })
})
...
describe('Create client', () => {
    ...
    it('create some clients', async() => {
        ...
        const result =await index.clientCreate({body: JSON.stringify(requestClient.createSeveral.body)})
        const body = JSON.parse(result.body)
console.log(body);
...
describe('Create Accountt', () => {
    it('create by client', async() => {
        const result = await index.accountCreateByMeter({body: JSON.stringify(requestClientAccount.body)})
        const body = JSON.parse(result.body)
        console.log(body);
